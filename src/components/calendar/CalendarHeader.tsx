  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <button
          onClick={onNewEvent}
          className="flex items-center gap-2 px-3 md:px-4 py-2 text-sm font-medium text-white rounded-lg bg-accent hover:bg-accent-hover active:scale-[0.98] shadow-sm transition-all duration-150"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
